...
export default function EditStartup() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (imageFile) {
                logoUrl = await uploadImage(imageFile, 'startup-logos', formData.logo_url);
            }

            const startupData: Database['public']['Tables']['startups']['Update'] = {
                name: formData.name,
    ...
    return (
        <div>
            <div className="mb-8">
                ...
                <p className="text-gray-600">Update startup details</p>
            </div>
