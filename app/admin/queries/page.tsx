...
export default function AdminQueriesPage() {
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-3xl font-heading text-primary-black">Contact Queries</h1>
                            ...
                            <div className="flex justify-between items-start mb-4">
                                <div>
                                    ...
                                    <div className="flex items-center gap-4 text-sm text-gray-500 mt-1">
                                        ...
                                        <span className="px-2 py-0.5 bg-primary-golden/10 text-primary-golden rounded-full text-xs font-bold uppercase">
                                            {query.name}
                                        </span>
                                    </div>
                                </div>
