                    ...
                    <div className="border-t border-gray-800 pt-6 mt-6">
                        ...
                        <div className="mb-4">
                            <label className={`flex items-center gap-3 ${formData.status === 'past' ? 'cursor-not-allowed opacity-60' : 'cursor-pointer'}`}>
                                ...
                                <span className={`${formData.status === 'past' ? 'text-gray-500' : 'text-gray-300'} font-medium`}>
                                    Registrations Open {formData.status === 'past' && '(Disabled for past events)'}
                                </span>
                            </label>
                        </div>
                        ...
                        {formData.is_team_event && (
                            <div className="grid grid-cols-2 gap-4 ml-8">
                                <div>
                                    <label htmlFor="min_team_size" className="block text-sm font-medium text-gray-300 mb-2">Min Team Size</label>
                                    <input
                                        id="min_team_size"
                                        type="number"
                                        min="1"
                                ...
                                <div>
                                    <label htmlFor="max_team_size" className="block text-sm font-medium text-gray-300 mb-2">Max Team Size</label>
                                    <input
                                        id="max_team_size"
                                        type="number"
                                        min="1"
