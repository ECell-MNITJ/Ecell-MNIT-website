            ...
            <div className="max-w-md w-full bg-gray-900 rounded-2xl shadow-2xl p-8 border border-gray-700">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-heading text-white mb-2">
                        E-SUMMIT <span className="text-purple-500">ADMIN</span>
                    </h1>
                    <p className="text-gray-400">Sign in to manage E-Summit</p>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-800">
                    <Link
                        href="/esummit"
                        className="flex items-center justify-center text-gray-400 hover:text-purple-400 transition-colors"
                    >
