...
-- Fix is_staff function to check admin_whitelist as well
-- This ensures that users who are admins in the whitelist but haven't had their profile role updated can still scan.
