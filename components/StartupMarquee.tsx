            ...
            <div className="flex w-max animate-marquee space-x-8 hover:[animation-play-state:paused] py-4">
                {marqueeItems.map((startup, index) => (
                    <div
                        ...
                        className="flex-shrink-0 w-52 md:w-72 h-64 md:h-80 bg-[#1f2937] rounded-2xl border border-gray-700 p-4 md:p-6 flex flex-col items-center text-center hover:border-primary-golden hover:-translate-y-2 transition-all duration-300 relative group shadow-xl"
                    >
                        {/* Logo */}
